...
import { colors, config, defaultConfig } from './common';
...
const argv = yargs
    ...
    .config("config", od(`JSONC config file ${odc("<配置置文件,命令参数优先级高于配置>")}`), config.loadConfig)
    .alias("c", "config")
...
Object.assign(defaultConfig, argv, { $0: undefined, _: undefined });
